...
public class TestEngine {
	...
	static void testCollection(String collectionPath, String indexPath, String word, String query) throws IOException {
		...
		System.out.println("\n  Total frequency of word \"" + word + "\" in the collection: " + index.getTotalFreq(word)
				+ " occurrences over " + index.getDocFreq(word) + " documents\n");
	...
	static void testSearch(SearchEngine engine, String query, int cutoff) throws IOException {
		System.out.println("  " + engine.getClass().getSimpleName() + ": top " + cutoff + " for query '" + query + "'");
