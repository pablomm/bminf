...
public class LuceneExample {
	public static void main(String a[]) throws IOException, ParseException {
		...
		String urls[] = { "https://en.wikipedia.org/wiki/Information_theory", "https://en.wikipedia.org/wiki/Entropy"
				// Más URLS aquí...
		};
		...
		for (int docID = 0; docID < index.numDocs(); docID++) {
			...
			for (int i = 0; i < terms.length; i++) {
				...
				terms[i] = new TermFreq(termString, iter.totalTermFreq(),
						index.docFreq(new Term("content", termString)));
				iter.next();
			}
